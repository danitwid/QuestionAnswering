...
def get_train_args():
    ...
    parser.add_argument('--train_embeddings',
                        type=lambda s: s.lower().startswith('t'),
                        default=False,
                        help='Whether to train word vectors.'),
...
def get_test_args():
    ...
    if not args.attention_type:
        raise argparse.ArgumentError('Missing required argument --attention_type')
...
def add_train_test_args(parser):
    ...
    parser.add_argument('--attention_type',
                        type=str,
                        default='BiDAF',
                        help='Attention Type for module.')
